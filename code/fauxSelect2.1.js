...
// versions 2.1a - added option to remove duplicates from the list
    ...
    $.FauxSelectBox.prototype = {
        ...
        buildList : function() {
            ...
            if (this.opts.removeDuplicate) {
                this.el.parent().find('[selected="true"]').css('display', 'none');
            }
        },
        ...
        addEvents : function() {
            ...
            selectList.find("li").each(function () {
               $(this).bind('click.' + fauxSelect.namespace, function () {
                   ...
                   // show hidden item
                   if (fauxSelect.opts.removeDuplicate) {
                     selectList.find('li').css('display', 'block');
                   }
